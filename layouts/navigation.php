...
<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
    <div class="container px-5">
        <a class="navbar-brand fw-bold" href="#page-top" style="display: flex; flex-direction:row;">
            <img src="assets/img/logo.jpeg"  height="50" />
            <div style="margin-left: 20px;" class="d-none d-md-block">
                <div class="text-dark">หลักสูตรวิทยาการข้อมูล</div>
                <div class="text-black-50 fs-6 fw-lighter">มหาวิทยาลัยราชภัฏวไลยอลงกรณ์ ในพระบรมราชูปถัมภ์</div>
            </div>
        </a>
